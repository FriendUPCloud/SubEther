...
statistics( $parent->module, 'booking' );

$root = 'subether/';
$cbase = 'subether/components/booking';

include_once ( $cbase . '/include/functions.php' );
include_once ( $root . 'components/events/include/functions.php' );

// Setup resources -------------------------------------------------------------
$document->addResource ( 'stylesheet', $cbase . '/css/booking.css' );
$document->addResource ( 'javascript', $cbase . '/javascript/booking.js' );

// Template: Module, Component, CategoryID, Status
SessionSet ( $parent->module, 'booking', $parent->folder->CategoryID, 'online' );
...
if ( isset( $_REQUEST[ 'action' ] ) )
{
	...
	die( 'failed action request - booking' );
}
...
else if ( isset( $_REQUEST[ 'function' ] ) )
{
	...
	die( 'failed function request - booking' );
}
else
{
	include ( $cbase . '/functions/bookingdate.php' );
	...
	{
		include ( $cbase . '/functions/booking.php' );
	}

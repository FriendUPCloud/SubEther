...
statistics( $parent->module, 'about' );

$root = 'subether/';
$cbase = 'subether/components/about';

// Setup resources -------------------------------------------------------------
$document->addResource ( 'stylesheet', $cbase . '/css/about.css' );
$document->addResource ( 'javascript', $cbase . '/javascript/about.js' );

// Template: Module, Component, CategoryID, Status
SessionSet ( $parent->module, 'about', $parent->folder->CategoryID, 'online' );
...
if ( isset( $_REQUEST[ 'action' ] ) )
{
	...
	die( 'failed action request - about' );
}
...
else if ( isset( $_REQUEST[ 'function' ] ) )
{
	...
	die( 'failed function request - about' );
}

...
*******************************************************************************/ ?>
<input type="hidden" id="ChatCategoryID" value="<?= $this->parent->folder->CategoryID ?>"/>
<div id="Messages">
	<div class="Box">
		<div class="toolbar">
			...
			<button type="button" onclick="ShowCryptoWindow('<?= $this->parent->folder->CategoryID ?>')">
				Crypto
			</button>
		</div>
		<div id="MainIM">
			<table>
				<tbody>
					<tr>
						<td class="leftCol">
							<div><div id="ListIM"><?= $this->ListIM ?></div></div>
						</td>
						<td class="rightCol">
							<div><div id="RightIM"><?= $this->RightIM ?></div></div>
						</td>
					</tr>
				</tbody>
			</table>
		</div>
		<?if ( $this->parent->folder->ObjectID ){ ?>
		<div class="post">

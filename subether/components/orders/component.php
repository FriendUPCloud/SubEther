...
statistics( $parent->module, 'orders' );

$root = 'subether/';
$cbase = 'subether/components/orders';
...
// Setup resources -------------------------------------------------------------
$document->addResource ( 'stylesheet', $cbase . '/css/orders.css' );
$document->addResource ( 'javascript', $cbase . '/javascript/calendar.js' );
$document->addResource ( 'javascript', $cbase . '/javascript/select.js' );
$document->addResource ( 'javascript', $cbase . '/javascript/orders.js' );

$document->addResource ( 'javascript', $root . 'components/admin/javascript/members.js' );
...
if ( isset( $_REQUEST[ 'action' ] ) )
{
	...
	output( 'failed action request - orders' );
}
...
else if ( isset( $_REQUEST[ 'function' ] ) )
{
	...
	output( 'failed function request - orders' );
}
else
{

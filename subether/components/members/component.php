...
statistics( $parent->module, 'members' );

$root = 'subether/';
$cbase = 'subether/components/members';

i18nAddLocalePath ( $cbase . '/locale' );

include_once ( $cbase . '/include/component.php' );
...
SessionSet ( $parent->module, 'members', $parent->folder->CategoryID, 'online' );
...
if ( isset( $_REQUEST[ 'action' ] ) )
{
	...
	die( 'failed action request - members' );
}
...
else if ( isset( $_REQUEST[ 'function' ] ) )
{
	...
	die( 'failed function request - members' );
}

// Render content to template --------------------------------------------------
include ( $cbase . '/functions/component.php' );

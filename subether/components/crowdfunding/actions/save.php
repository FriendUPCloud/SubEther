...
if( $webuser->ContactID > 0 && ( isset( $_POST['name'] ) || isset( $_POST['pid'] ) ) )
{
	...
	$p->Location 	    = ( isset( $_POST['location'] ) ? $_POST['location'] : $p->Location );
	$p->Tags 	  	    = ( isset( $_POST['tags'] ) ? $_POST['tags'] : $p->Tags );
	$p->Goal 	  	    = ( isset( $_POST['goal'] ) ? $_POST['goal'] : $p->Goal );
	$p->Currency 	    = ( isset( $_POST['currency'] ) ? $_POST['currency'] : $p->Currency );
	$p->DateEnd 	    = ( isset( $_POST['end'] ) ? $_POST['end'] : $p->DateEnd );
	$p->Status 	   	    = ( isset( $_POST['status'] ) ? $_POST['status'] : $p->Status );

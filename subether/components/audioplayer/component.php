...
statistics( $parent->module, 'audioplayer' );

$root = 'subether/';
$cbase = 'subether/components/audioplayer';

//include_once ( $cbase . '/include/functions.php' );

// Setup resources -------------------------------------------------------------
$document->addResource ( 'stylesheet', $cbase . '/css/audioplayer.css' );
$document->addResource ( 'javascript', $cbase . '/javascript/audioplayer.js' );
...
if ( isset( $_REQUEST[ 'action' ] ) )
{
	...
	output( 'failed action request - audioplayer' );
}
...
else if ( isset( $_REQUEST[ 'function' ] ) )
{
	...
	output( 'failed function request - audioplayer' );
}

...
statistics( $parent->module, 'bookmarks' );

$root = 'subether/';
$cbase = 'subether/components/bookmarks';

// Setup resources -------------------------------------------------------------
//$document->addResource ( 'stylesheet', $cbase . '/css/bookmarks.css' );
//$document->addResource ( 'javascript', $cbase . '/javascript/bookmarks.js' );

// Template: Module, Component, CategoryID, Status
SessionSet ( $parent->module, 'bookmarks', $parent->folder->CategoryID, 'online' );
...
if ( isset( $_REQUEST[ 'action' ] ) )
{
	...
	die( 'failed action request - bookmarks' );
}
...
else if ( isset( $_REQUEST[ 'function' ] ) )
{
	...
	die( 'failed function request - bookmarks' );
}

// Render content to template --------------------------------------------------
include ( $cbase . '/functions/bookmarks.php' );
$Component->Content = $bstr;

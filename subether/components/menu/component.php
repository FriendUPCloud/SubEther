...
statistics( $parent->module, 'menu' );

$root = 'subether/';
$cbase = 'subether/components/menu';

include_once ( $cbase . '/include/functions.php' );
include_once ( $cbase . '/functions/component.php' );

// Setup resources -------------------------------------------------------------
$document->addResource ( 'stylesheet', $cbase . '/css/menu.css' );
...
if ( isset( $_REQUEST[ 'action' ] ) )
{
	...
	die( 'failed action request - menu' );
}
...
else if ( isset( $_REQUEST[ 'function' ] ) )
{
	...
	die( 'failed function request - menu' );
}

...
statistics( $parent->module, 'search' );

$root = 'subether/';
$cbase = 'subether/components/search';

// Setup resources -------------------------------------------------------------
$document->addResource ( 'stylesheet', $cbase . '/css/main.css' );
$document->addResource ( 'stylesheet', $cbase . '/css/results.css' );
$document->addResource ( 'javascript', $cbase . '/javascript/main.js' );

include_once ( $cbase . '/include/functions.php' );
include_once ( $cbase . '/include/spider.php' );
...
if ( isset( $_REQUEST[ 'action' ] ) )
{
	...
	die( 'failed action request - search' );
}
...
else if ( isset( $_REQUEST[ 'function' ] ) )
{
	...
	die( 'failed function request - search' );
}

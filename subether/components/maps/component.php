...
statistics( $parent->module, 'maps' );

$root = 'subether/';
$cbase = 'subether/components/maps';
$folder = $Component->parent->folder;

// Setup resources -------------------------------------------------------------
$document->addResource ( 'stylesheet', $cbase . '/css/maps.css' );
$document->addResource ( 'javascript', $cbase . '/javascript/maps.js' );

// Template: Module, Component, CategoryID, Status
SessionSet ( $parent->module, 'maps', $parent->folder->CategoryID, 'online' );
...
if ( isset( $_REQUEST[ 'action' ] ) )
{
	...
	die( 'failed action request - maps' );
}
...
else if ( isset( $_REQUEST[ 'function' ] ) )
{
	...
	die( 'failed function request - maps' );
}

// Render content to template --------------------------------------------------
include ( $cbase . '/functions/maps.php' );

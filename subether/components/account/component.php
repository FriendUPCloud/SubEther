...
global $document, $cachedUserData;

statistics( $parent->module, 'account' );

$root = 'subether/';
$cbase = 'subether/components/account';

include_once ( $root . '/components/library/include/functions.php' );
include_once ( $cbase . '/include/functions.php' );

// Setup resources -------------------------------------------------------------
$document->addResource ( 'stylesheet', $cbase . '/css/account.css' );
$document->addResource ( 'javascript', $cbase . '/javascript/account.js' );
...
if ( isset( $_REQUEST[ 'action' ] ) )
{
	...
	die( 'failed action request - account' );
}
...
else if ( isset( $_REQUEST[ 'function' ] ) )
{
	...
	die( 'failed function request - account' );
}

// Render content to template --------------------------------------------------
include ( $cbase . '/functions/tabs.php' );
